...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 16, 2021 at 03:52 AM
...
--
-- Dumping data for table `tb_communities`
--

INSERT INTO `tb_communities` (`id`, `nama`, `description`, `photo`, `interest`, `members`) VALUES
(1, 'Kelompok Aktivis Pantai', 'Kelompok pecinta sekaligus penjaga ekosistem pantai yang ada di Indonesia', '', '', 'a:2:{i:0;s:4:\"bayu\";i:1;s:5:\"bayus\";}'),
(2, 'Programming club', 'Programming club', 'xx', 'programming', 'a:1:{i:0;s:7:\"bayusam\";}'),
(3, 'MLBB', 'Ayo push rank', 'xxx', 'mobile legends', 'a:1:{i:0;s:5:\"bayus\";}');
...
--
-- Indexes for table `tb_communities`
--
...
--
-- AUTO_INCREMENT for table `tb_communities`
--
ALTER TABLE `tb_communities`
